...
import avaas.apilot.kafka.dto.APilotDTO;
import avaas.apilot.model.APilot;

@Service
public class APilotKafkaConsumer {

	@KafkaListener(topics="apilot", groupId="apilot")
	public void consumeFromTopic(String msg) {

		System.out.println("Consumed APilot = " + msg);
